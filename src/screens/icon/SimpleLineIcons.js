...
const SimpleLineIconsExample = (props) => {
  const Icons = SimpleLineIcons;
  ...
  return (
    <Container>
      <Header
        ...
        <Body>
          <Title>Icon</Title>
          <Subtitle>SimpleLineIcons</Subtitle>
        </Body>
        <Right />
      </Header>
      <Content padder>
...
export default connect(mapStateToProps)(SimpleLineIconsExample);
