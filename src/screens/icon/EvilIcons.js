...
import EvilIcons from './icons/EvilIcons';

const EvilIconsExample = (props) => {
  const Icons = EvilIcons;
...
export default connect(mapStateToProps)(EvilIconsExample);
